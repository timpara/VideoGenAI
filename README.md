...
### Run in Google Colab
Want to try VideoGenAI without setting up a local environment? Run it directly in Google Colab!
...
Note that you need to execute the following commands in the `root directory` of the VideoGenAI project
...
After downloading the model, extract it and place the entire directory in `.\VideoGenAI\models`,
The final file path should look like this: `.\VideoGenAI\models\whisper-large-v3`
...
[issue 33](https://github.com/timpara/VideoGenAI/issues/33)
...
[issue 54](https://github.com/timpara/VideoGenAI/issues/54)
...
- You can submit an [issue](https://github.com/timpara/VideoGenAI/issues) or
  a [pull request](https://github.com/timpara/VideoGenAI/pulls).
